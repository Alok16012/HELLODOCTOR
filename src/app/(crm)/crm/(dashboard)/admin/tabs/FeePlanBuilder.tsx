...
const ALL_FEATURES = [
  ...
  'Practical Support',
  'Practical Support by Hello Doctor',
  'Assignment Support',
  'Assignment Support by Hello Doctor',
  'Exam Support',
  'Exam Support by Hello Doctor',
...
const DEFAULT: FeeState = {
  ...
  plans: {
    ...
    premium: {
      name: 'Premium Plan', icon: '👑', tagline: 'Complete support — everything by Hello Doctor',
      featuresLabel: 'EVERYTHING IN STANDARD, PLUS', highlighted: false, guarantee: '3 chance guarantee — else full refund',
      papers: [{ label: '1 Paper', price: '' }, { label: '2 Papers', price: '' }, { label: '3 Papers', price: '' }, { label: 'Full Subject', price: '' }],
      features: ['Confirm Admission', 'WhatsApp Updates', 'Call Updates by Mentor', 'Dedicated Mentor Support', 'Practical Support by Hello Doctor', 'Assignment Support by Hello Doctor', 'Exam Support by Hello Doctor', 'College Admission Support', 'Assured Result', 'Document Dispatch'],
    },
  },
}
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">Design and download a branded Hello Doctor fee plan PDF</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-xl p-4 bg-white space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1"><Label className="text-xs text-slate-500">Mobile Number</Label><Input value={state.phone} onChange={e => set('phone', e.target.value)} placeholder="+91 92116 07005" /></div>
          ...
          <div className="rounded-xl overflow-hidden border border-slate-200 shadow-xl"
            ...
            <div style={{ background: '#0f172a', borderRadius: 8, padding: '10px 14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <img src="/brand-logo.png" alt="Hello Doctor" style={{ width: 36, height: 36, borderRadius: 6, objectFit: 'cover', flexShrink: 0 }} />
                <div>
            ...
            <div style={{ marginTop: 10, borderTop: '1px solid #e2e8f0', paddingTop: 7, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ color: '#94a3b8', fontSize: 8 }}>Hello Doctor | {state.boardTag} | {state.sessionTag}</div>
