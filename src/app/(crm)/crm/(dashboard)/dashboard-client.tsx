        ...
        <div className="space-y-3">
          ...
          {isLead && (
            <div className="grid grid-cols-3 gap-2.5">
              <Link href="/crm/leads?status=interested" className="rounded-xl border border-yellow-100 bg-yellow-50 p-3.5 hover:bg-yellow-100 transition-all text-left group">
              ...
              <Link href="/crm/leads?followup=today" className="rounded-xl border border-orange-100 bg-orange-50 p-3.5 hover:bg-orange-100 transition-all text-left group">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
              ...
              <Link href="/crm/leads?status=document_received" className="rounded-xl border border-blue-100 bg-blue-50 p-3.5 hover:bg-blue-100 transition-all text-left group">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-1.5">
              ...
              <div className="md:hidden divide-y divide-gray-50">
                {followupsToday.map((l) => (
                  <div key={l.id} className="px-4 py-3.5 flex items-center gap-3 hover:bg-orange-50/40 transition-colors">
                    <Link href={`/crm/leads/${l.id}`} className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
          ...
          <div className="md:hidden divide-y divide-gray-50">
            {departmentStats.map((dept) => (
              <Link key={dept.id} href={`/crm/backend?dept=${dept.id}`} className="block px-4 py-3.5 hover:bg-blue-50/40 transition-colors">
              ...
              {departmentStats.map((dept) => (
                <tr key={dept.id} className="hover:bg-slate-50 transition-colors">
                  <td className="px-5 py-3 font-medium text-blue-600 hover:text-blue-800 hover:underline">
                    <Link href={`/crm/backend?dept=${dept.id}`}>{dept.name}</Link>
                  </td>
      ...
      {myTasks.length > 0 && (
        <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
          <div className="px-4 py-3.5 border-b bg-gradient-to-r from-blue-50 to-blue-50 flex items-center justify-between">
            ...
            <Link href="/crm/tasks" className="text-xs text-blue-600 hover:underline flex items-center gap-0.5">
          ...
          <div className="px-4 py-2.5 border-t bg-slate-50">
            <Link href="/crm/tasks" className="text-xs text-blue-600 hover:underline font-medium flex items-center gap-1">
