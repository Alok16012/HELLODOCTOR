  ...
  if (!assoc) {
    return (
      <div className="space-y-4">
        <button onClick={() => router.push('/crm/associates')} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-800"><ArrowLeft className="w-4 h-4" /> Back</button>
  ...
  return (
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="flex items-center justify-between gap-3">
        <button onClick={() => router.push('/crm/associates')} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-800 font-medium">
