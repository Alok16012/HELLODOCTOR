    ...
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="bg-gradient-to-r from-emerald-900/80 to-green-900/80 border border-emerald-700/50 rounded-2xl px-5 py-4 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm font-bold text-white">Hello Doctor Support Team</p>
      ...
      <div className="grid grid-cols-4 md:grid-cols-7 gap-2.5">
        {[
          { label: 'Add Lead',    href: '/crm/associate/admissions?new=1',icon: Users,         color: 'text-blue-600',    bg: 'bg-blue-50' },
          { label: 'My Students', href: '/crm/associate/students',         icon: GraduationCap, color: 'text-indigo-600',  bg: 'bg-indigo-50' },
          { label: 'Accounts',    href: '/crm/associate/account',          icon: IndianRupee,   color: 'text-emerald-600', bg: 'bg-emerald-50' },
          { label: 'Dispatch',    href: '/crm/associate/dispatch',         icon: Package,       color: 'text-blue-600',  bg: 'bg-blue-50' },
          { label: 'Resources',   href: '/crm/associate/resources',        icon: BarChart2,     color: 'text-orange-600',  bg: 'bg-orange-50' },
          { label: 'Support',     href: '/crm/associate/support',          icon: AlertCircle,   color: 'text-rose-600',    bg: 'bg-rose-50' },
          { label: 'Profile',     href: '/crm/associate/profile',          icon: UserCheck,     color: 'text-gray-600',    bg: 'bg-gray-100' },
      ...
      {students.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            ...
            <Link href="/crm/associate/students" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-medium">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            ...
            <Link href="/crm/associate/admissions" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-medium">
              View all <ChevronRight className="h-3 w-3" />
            </Link>
          </div>
          ...
          <div className="px-5 py-3 border-t border-gray-50">
            <Link href="/crm/associate/admissions?new=1" className="w-full flex items-center justify-center gap-2 text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors">
              + Add New Lead
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            ...
            <Link href="/crm/associate/account" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-medium">
              View all <ChevronRight className="h-3 w-3" />
            </Link>
          </div>
          {recentTxns.length === 0 ? (
      ...
      {notifications.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            ...
            <Link href="/crm/associate/notifications" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-medium">
