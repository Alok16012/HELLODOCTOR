...
export default async function FinancePage() {
  ...
  if (!profile || !['admin', 'backend', 'associate'].includes(profile.role)) redirect('/')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <Link href="/crm/finance/income" className="group rounded-lg border p-4 hover:bg-muted/50 transition-colors flex justify-between items-center">
          <div>
        ...
        <Link href="/crm/finance/expenses" className="group rounded-lg border p-4 hover:bg-muted/50 transition-colors flex justify-between items-center">
          <div>
