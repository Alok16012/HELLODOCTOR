...
export default async function StudentDashboardPage() {
  ...
  if (!user) redirect('/crm/student/login')
  ...
  if (!student) redirect('/crm/student/login')
    ...
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center justify-between mb-1">
          ...
          <Link href="/crm/student/admission" className="text-xs text-blue-600 flex items-center gap-1 hover:underline font-semibold">
      ...
      <div className="grid grid-cols-5 gap-3">
        {[
          { label: 'My Admission',    href: '/crm/student/admission', icon: GraduationCap, color: 'text-blue-600',    bg: 'bg-blue-50',    hover: 'hover:bg-blue-100'    },
          { label: 'Accounts',        href: '/crm/student/accounts',  icon: IndianRupee,   color: 'text-emerald-600', bg: 'bg-emerald-50', hover: 'hover:bg-emerald-100' },
          { label: 'Study Materials', href: '/crm/student/materials', icon: BookOpen,      color: 'text-blue-600',  bg: 'bg-blue-50',  hover: 'hover:bg-blue-100'  },
          { label: 'Help & Support',  href: '/crm/student/support',   icon: HelpCircle,    color: 'text-orange-600',  bg: 'bg-orange-50',  hover: 'hover:bg-orange-100'  },
          { label: 'My Profile',      href: '/crm/student/profile',   icon: User,          color: 'text-indigo-600',  bg: 'bg-indigo-50',  hover: 'hover:bg-indigo-100'  },
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
            ...
            <Link href="/crm/student/support" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-medium">
      ...
      {s.total_fee && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/crm/student/accounts" className="text-xs text-blue-600 hover:underline flex items-center gap-1 font-semibold">
