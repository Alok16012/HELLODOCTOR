...
export default function StudentLoginPage() {
  ...
  async function onSubmit(data: LoginForm) {
    ...
    try {
      ...
      window.location.replace('/crm/student/dashboard')
    } catch {
            ...
            <div className="hidden md:flex w-5/12 bg-gradient-to-br from-blue-700 to-indigo-900 p-10 flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h1 className="text-white font-bold text-lg leading-tight">Hello Doctor</h1>
              ...
              <div className="max-w-sm w-full mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-gray-400">Enter your enrollment number exactly as given (e.g. HD-873254)</p>
                  </div>
