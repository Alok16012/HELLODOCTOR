...
const ITEMS = [
  { label: 'Home',      href: '/crm/student/dashboard', icon: Home },
  { label: 'Admission', href: '/crm/student/admission', icon: GraduationCap },
  { label: 'Accounts',  href: '/crm/student/accounts',  icon: Wallet },
  { label: 'Materials', href: '/crm/student/materials', icon: BookOpen },
]
...
export function StudentBottomNav() {
  ...
  const isActive = (href: string) =>
    pathname === href || (href !== '/crm/student/dashboard' && pathname.startsWith(href))
