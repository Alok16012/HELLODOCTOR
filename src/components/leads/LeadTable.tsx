          ...
          {paginated.map((lead) => (
            <div key={lead.id} className="px-4 py-4 hover:bg-gray-50/60 transition-colors">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0 cursor-pointer" onClick={() => router.push(`/crm/leads/${lead.id}`)}>
                ...
                <div onClick={(e) => e.stopPropagation()}>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-44">
                      <DropdownMenuItem onClick={() => router.push(`/crm/leads/${lead.id}`)}>View Details</DropdownMenuItem>
