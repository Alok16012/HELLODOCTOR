...
const TABS = [
  { href: '/crm/hrms',            label: 'Employees',  icon: Users,         exact: true },
  { href: '/crm/hrms/attendance', label: 'Attendance', icon: CalendarCheck, exact: false },
  { href: '/crm/hrms/payroll',    label: 'Payroll',    icon: Banknote,      exact: false },
  { href: '/crm/hrms/advances',   label: 'Advances',   icon: Wallet,        exact: false },
]
