          ...
          <div className="absolute right-0 top-10 z-50 w-80 sm:w-96 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="overflow-y-auto max-h-[440px]">
              ...
              {followups.length > 0 && (
                <div>
                  ...
                  <div className="divide-y divide-gray-50">
                    {followups.map(f => (
                      <a key={f.id} href={`/crm/leads/${f.id}`} onClick={() => setOpen(false)}
            ...
            {tasks.length > 0 && (
              <div className="border-t px-4 py-2.5 bg-gray-50">
                <a href="/crm/tasks" className="text-xs text-blue-600 hover:underline font-medium" onClick={() => setOpen(false)}>
                  View all tasks →
                </a>
              </div>
            )}
