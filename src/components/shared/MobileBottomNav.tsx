...
const NAV: Record<string, Item[]> = {
  admin: [
    { label: 'Home',       href: '/crm/dashboard',  icon: Home },
    { label: 'Leads',      href: '/crm/leads',      icon: Users },
    { label: 'Students',   href: '/crm/backend',    icon: GraduationCap },
    { label: 'Targets',    href: '/crm/targets',    icon: TrendingUp },
  ],
  backend: [
    { label: 'Home',     href: '/crm/dashboard', icon: Home },
    { label: 'Leads',    href: '/crm/leads',     icon: Users },
  ...
  lead: [
    ...
    { label: 'Leads',      href: '/crm/leads',      icon: Users },
    { label: 'Targets',    href: '/crm/targets',    icon: TrendingUp },
    { label: 'Mentorship', href: '/crm/mentorship', icon: Award },
  ],
  counselor: [
    { label: 'Home',       href: '/crm/dashboard',  icon: Home },
    { label: 'Leads',      href: '/crm/leads',      icon: Users },
  ...
  associate: [
    { label: 'Home',     href: '/crm/associate',            icon: Home },
    { label: 'Leads',    href: '/crm/associate/admissions', icon: Users },
    { label: 'Students', href: '/crm/associate/students',   icon: GraduationCap },
    { label: 'Accounts', href: '/crm/associate/account',    icon: Wallet },
  ],
  housekeeping: [
    { label: 'Attendance', href: '/crm/attendance', icon: ClockIcon },
  ],
}
...
export function MobileBottomNav({ role }: { role: UserRole }) {
  ...
  const isActive = (href: string) =>
    pathname === href || (href !== '/crm/dashboard' && href !== '/crm/associate' && pathname.startsWith(href))
