module.exports=[17262,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(71133),e=a.i(38246);let f=[{name:"All",slug:"all"},{name:"Admission Guide",slug:"admission-guide"},{name:"Entrance Exams",slug:"entrance-exams"},{name:"Rankings",slug:"rankings"},{name:"Career Advice",slug:"career-advice"},{name:"Scholarships",slug:"scholarships"},{name:"Study Abroad",slug:"study-abroad"},{name:"College Life",slug:"college-life"}],g=[{id:1,slug:"jee-advanced-2025-complete-guide",title:"JEE Advanced 2025: Complete Guide to Crack India's Toughest Exam",excerpt:"Everything you need to know about JEE Advanced 2025 — eligibility, syllabus, preparation strategy, and tips from IIT toppers.",content:`
...
For a ₹70 lakh investment (4 years in USA), you'd need a starting salary of ₹1.5 crore/year to recover in under 2 years (at US salary levels, this is achievable in tech). For Germany (near-zero fees), it's almost always worth it. Calculate your expected ROI based on target country and field before committing.
    `,category:"Study Abroad",tags:["Study Abroad","USA","UK","Germany","Scholarship","International Education"],author:"Meera Krishnan",authorRole:"International Admissions Consultant",authorAvatar:"https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&q=80",publishedAt:"2025-05-05",readTime:10,image:"https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1200&q=80",featured:!1}];var h=a.i(73885),i=a.i(56283),j=a.i(8311),k=a.i(18688),l=a.i(43419);let m=(0,a.i(64831).default)("bookmark",[["path",{d:"M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z",key:"oz39mx"}]]);function n(a){return new Date(a).toLocaleDateString("en-IN",{day:"numeric",month:"long",year:"numeric"})}a.s(["default",0,function(){let[a,o]=(0,c.useState)("all"),p="all"===a?g:g.filter(b=>b.category.toLowerCase().replace(/\s+/g,"-")===a),q=g.filter(a=>a.featured).slice(0,3);return g.sort((a,b)=>new Date(b.publishedAt).getTime()-new Date(a.publishedAt).getTime()),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(h.default,{}),(0,b.jsxs)("div",{className:"bg-gray-50 min-h-screen",children:[(0,b.jsx)("div",{className:"bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 py-14 px-4",children:(0,b.jsxs)("div",{className:"max-w-7xl mx-auto text-center",children:[(0,b.jsxs)("div",{className:"inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 text-sm font-medium px-4 py-2 rounded-full mb-5 border border-blue-500/30",children:[(0,b.jsx)(k.BookOpen,{className:"w-4 h-4"}),"Education Resources & Guides"]}),(0,b.jsxs)("h1",{className:"text-3xl sm:text-5xl font-bold text-white mb-4",children:["College Admission ",(0,b.jsx)("span",{className:"text-blue-400",children:"Blog"})]}),(0,b.jsx)("p",{className:"text-gray-300 text-lg max-w-xl mx-auto",children:"Expert guides, exam tips, college rankings analysis, and career advice to help you make the best decisions for your future."}),(0,b.jsxs)("div",{className:"flex flex-wrap justify-center gap-6 mt-7 text-gray-400 text-sm",children:[(0,b.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,b.jsx)(k.BookOpen,{className:"w-4 h-4 text-blue-400"})," ",g.length," Articles"]}),(0,b.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,b.jsx)(l.TrendingUp,{className:"w-4 h-4 text-green-400"})," Updated Weekly"]}),(0,b.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,b.jsx)(m,{className:"w-4 h-4 text-yellow-400"})," Expert Authors"]})]})]})}),(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 py-10",children:[(0,b.jsxs)("div",{className:"mb-12",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between mb-6",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold text-gray-900",children:"Featured Articles"}),(0,b.jsx)("span",{className:"text-sm text-gray-500",children:"Hand-picked by our editors"})]}),(0,b.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-6",children:[(0,b.jsx)("div",{className:"lg:col-span-2",children:q[0]&&(0,b.jsx)(e.default,{href:`/blog/${q[0].slug}`,children:(0,b.jsxs)("div",{className:"relative h-72 sm:h-96 rounded-2xl overflow-hidden group cursor-pointer",children:[(0,b.jsx)(d.default,{src:q[0].image,alt:q[0].title,fill:!0,className:"object-cover group-hover:scale-105 transition-transform duration-500"}),(0,b.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent"}),(0,b.jsx)("div",{className:"absolute top-4 left-4",children:(0,b.jsx)("span",{className:"bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full",children:q[0].category})}),(0,b.jsxs)("div",{className:"absolute inset-x-0 bottom-0 p-6",children:[(0,b.jsx)("h3",{className:"text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors",children:q[0].title}),(0,b.jsx)("p",{className:"text-white/70 text-sm line-clamp-2 mb-3",children:q[0].excerpt}),(0,b.jsxs)("div",{className:"flex items-center gap-3 text-white/60 text-xs",children:[(0,b.jsx)("span",{children:q[0].author}),(0,b.jsx)("span",{children:"·"}),(0,b.jsx)(j.Clock,{className:"w-3.5 h-3.5"}),(0,b.jsxs)("span",{children:[q[0].readTime," min read"]}),(0,b.jsx)("span",{children:"·"}),(0,b.jsx)("span",{children:n(q[0].publishedAt)})]})]})]})})}),(0,b.jsx)("div",{className:"space-y-4",children:q.slice(1,3).map(a=>(0,b.jsx)(e.default,{href:`/blog/${a.slug}`,children:(0,b.jsxs)("div",{className:"relative h-44 rounded-2xl overflow-hidden group cursor-pointer",children:[(0,b.jsx)(d.default,{src:a.image,alt:a.title,fill:!0,className:"object-cover group-hover:scale-105 transition-transform duration-500"}),(0,b.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"}),(0,b.jsx)("div",{className:"absolute top-3 left-3",children:(0,b.jsx)("span",{className:"bg-blue-600/90 text-white text-xs font-bold px-2.5 py-0.5 rounded-full",children:a.category})}),(0,b.jsxs)("div",{className:"absolute inset-x-0 bottom-0 p-4",children:[(0,b.jsx)("h3",{className:"text-sm font-bold text-white mb-1 line-clamp-2 group-hover:text-blue-300 transition-colors",children:a.title}),(0,b.jsxs)("div",{className:"flex items-center gap-2 text-white/60 text-xs",children:[(0,b.jsx)(j.Clock,{className:"w-3 h-3"}),(0,b.jsxs)("span",{children:[a.readTime," min"]}),(0,b.jsx)("span",{children:"·"}),(0,b.jsx)("span",{children:n(a.publishedAt)})]})]})]})},a.id))})]})]}),(0,b.jsx)("div",{className:"flex flex-wrap gap-2 mb-8",children:f.map(c=>(0,b.jsxs)("button",{onClick:()=>o(c.slug),className:`px-4 py-2 rounded-full text-sm font-medium transition-all ${a===c.slug?"bg-blue-600 text-white shadow-sm":"bg-white text-gray-600 border border-gray-200 hover:border-blue-300 hover:text-blue-600"}`,children:[c.name,"all"!==c.slug&&(0,b.jsxs)("span",{className:`ml-1.5 text-xs ${a===c.slug?"text-blue-200":"text-gray-400"}`,children:["(",g.filter(a=>a.category.toLowerCase().replace(/\s+/g,"-")===c.slug).length,")"]})]},c.slug))}),(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"flex items-center justify-between mb-5",children:(0,b.jsxs)("h2",{className:"text-xl font-bold text-gray-900",children:["all"===a?"All Articles":f.find(b=>b.slug===a)?.name,(0,b.jsxs)("span",{className:"text-gray-400 font-normal text-base ml-2",children:["(",p.length,")"]})]})}),(0,b.jsx)("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",children:p.map(a=>(0,b.jsx)(e.default,{href:`/blog/${a.slug}`,children:(0,b.jsxs)("article",{className:"bg-white rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 overflow-hidden group h-full flex flex-col",children:[(0,b.jsxs)("div",{className:"relative h-48 overflow-hidden shrink-0",children:[(0,b.jsx)(d.default,{src:a.image,alt:a.title,fill:!0,className:"object-cover group-hover:scale-105 transition-transform duration-500",sizes:"(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"}),(0,b.jsx)("div",{className:"absolute top-3 left-3",children:(0,b.jsx)("span",{className:"bg-blue-600 text-white text-xs font-bold px-2.5 py-1 rounded-full",children:a.category})})]}),(0,b.jsxs)("div",{className:"p-5 flex flex-col flex-1",children:[(0,b.jsx)("h3",{className:"font-bold text-gray-900 text-base leading-snug mb-2 group-hover:text-blue-600 transition-colors line-clamp-2",children:a.title}),(0,b.jsx)("p",{className:"text-gray-500 text-sm line-clamp-2 mb-4 flex-1",children:a.excerpt}),(0,b.jsx)("div",{className:"flex flex-wrap gap-1.5 mb-4",children:a.tags.slice(0,3).map(a=>(0,b.jsxs)("span",{className:"text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full",children:["#",a]},a))}),(0,b.jsxs)("div",{className:"flex items-center gap-3 pt-3 border-t border-gray-100",children:[(0,b.jsx)(d.default,{src:a.authorAvatar,alt:a.author,width:28,height:28,className:"rounded-full object-cover"}),(0,b.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,b.jsx)("p",{className:"text-xs font-semibold text-gray-800 truncate",children:a.author}),(0,b.jsx)("p",{className:"text-xs text-gray-400",children:n(a.publishedAt)})]}),(0,b.jsxs)("div",{className:"flex items-center gap-1 text-gray-400 text-xs shrink-0",children:[(0,b.jsx)(j.Clock,{className:"w-3 h-3"}),a.readTime,"m"]})]})]})]})},a.id))}),0===p.length&&(0,b.jsxs)("div",{className:"text-center py-16 text-gray-400",children:[(0,b.jsx)(k.BookOpen,{className:"w-12 h-12 mx-auto mb-3 opacity-30"}),(0,b.jsx)("p",{className:"text-lg",children:"No articles in this category yet."})]})]}),(0,b.jsxs)("div",{className:"mt-16 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 sm:p-12 text-center",children:[(0,b.jsx)("h2",{className:"text-2xl sm:text-3xl font-bold text-white mb-3",children:"Stay Ahead with Latest Updates"}),(0,b.jsx)("p",{className:"text-blue-100 mb-6 max-w-xl mx-auto",children:"Get exam dates, admission alerts, scholarship deadlines, and expert articles directly in your inbox."}),(0,b.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3 max-w-md mx-auto",children:[(0,b.jsx)("input",{type:"email",placeholder:"Enter your email address",className:"flex-1 px-4 py-3 rounded-xl text-sm bg-white/15 border border-white/30 text-white placeholder-white/50 focus:outline-none focus:border-white/60"}),(0,b.jsx)("button",{className:"bg-white text-blue-600 font-bold px-6 py-3 rounded-xl hover:bg-blue-50 transition-colors text-sm whitespace-nowrap",children:"Subscribe Free"})]})]})]})]}),(0,b.jsx)(i.default,{})]})}],17262)}];

//# sourceMappingURL=src_app_blog_page_tsx_04abz3q._.js.map